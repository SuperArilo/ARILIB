...
public class Teleporting {
    ...
    protected Teleporting(JavaPlugin plugin, Entity entity, Location targetLocation) {
        this.plugin = plugin;
        this.entity = entity;
    ...
    public Teleporting teleport() {
        ...
        Lib.Scheduler.runAtRegion(this.plugin, this.targetLocation, i -> {
            ...
            this.entity.teleportAsync(this.targetLocation,
                    ...
                    .thenAccept(p -> {
                        ...
                        this.after.run();
                        this.entity.sendMessage(LibConfigUtils.t(p ? "function.teleport.success":"function.teleport.error"));
                    });
        });
        return this;
    }
    ...
    public static Teleporting create(JavaPlugin plugin, Entity entity, Location targetLocation) {
        return new Teleporting(plugin, entity, targetLocation);
    }
